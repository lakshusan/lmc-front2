...
permalink: /cook
---
<link rel="stylesheet" href="/lmc-front2/LMC/JS/SCSS/cook.css">
<div id="point-container">
    <img src="/lmc-front2/images/star.png" id=star>
...
<!--  -->
    ...
    const images = []
            for (let j = 0; j < lenIngredients; j++){
                ...
                images.push('/lmc-front2/images/' + ownedItems[j] + '.png')
            }
    console.log(images)
    ...
    function bake() {
        ...
        fetch(url, options)
            ...
            response.json().then(data => {
                ...
                {
                    console.log('failure');
                    alert('failure: recipe does not exist')
                }
                })
            })
        //
...
<script src="/lmc-front2/LMC/JS/dragFood.js"></script>
